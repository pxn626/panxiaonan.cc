...
if(!empty($logData['web'])){
  $web = '<span class="downfile"><a href="'.$logData['web'].'" target="_blank">90网盘<font color="white">(推荐)</font></a></span>';
}
if(!empty($logData['ctldown'])){
  $ctldown = '<span class="downfile"><a href="'.$logData['ctldown'].'" target="_blank">城通网盘<font color="white">(推荐)</font></a></span>';
}
if(!empty($logData['general'])){
  $general = '<span class="downfile"><a href="'.$logData['general'].'" target="_blank">118网盘</a></span>';
}
?>
...
<link href="http://www.panxiaonan.cc/emlog/content/plugins/cpdown/style/show.css" type="text/css" rel="stylesheet" />
...
<script src="http://www.panxiaonan.cc/emlog/content/plugins/cpdown/style/show.js" type="text/javascript"></script>
</head>
<body>
<div class="topbar">
  <div class="top">
    <div class="top_left">您好，欢迎进入网中小南下载页面！</div>
    <div class="top_right"><a href="<?php echo URL::log($id); ?>" title="返回文章页面"><i class="fa fa-th-large"></i>返回文章页面</a><span>|</span><a href="<?php echo BLOG_URL; ?>"><i class="fa fa-home"></i>网站首页</a></div>
  </div>
</div>
<div class="wrap">
<div class="content">
...
<div class="plus_l">
  <ul>
    <!--<li>演示地址 ：<a href="<?php echo $logData['yanshi']; ?>">点击查看</a></li>-->
...
<div class="panel">
 ...
 <div class="panel-body">
  <ul class="help">
    <li>1、本站提供的压缩包若无特别说明，解压密码均为<em>www.panxiaonan.cc</em></li>
