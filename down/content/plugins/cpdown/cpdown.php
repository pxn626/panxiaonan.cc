...
Plugin Name: 独立文件下载
Version: 1.1
Plugin URL：http://www.dyboy.cn/post-454.html
Description: 独立的下载页面方便自由化定制，插入广告，独立的查看演示页面，方便插入广告和自由化定制
Author: 原作蓝叶 兮晰丶而我 美化
Author URL: http://www.dyboy.cn/post-453.html
*/
    ...
    <div class="col-lg-12">
        <table class="table">
            <tbody>
                ...
                <tr>
                    <th style="width:15%;"><label>118网盘</label></th>
