...
<div class="em_static">
	<div class="containertitle2">
		...
		<a class="navi3" href="?plugin=em_static&do=create_all">全站生成</a>
...
<p>
	...
	日志页面 - 每次生成<input type="text" name="post_limit" value="5" size="2" maxlength="3"/>篇
	<a href="?plugin=em_static&do=url#post">url格式设置 &GT;&GT;</a>
</p>
<p>
	<input type="checkbox" name="create_pages[]" value="page" />
	日志列表 - 每次生成<input type="text" name="list_limit" value="5" size="2" maxlength="3"/>页
	<a href="?plugin=em_static&do=url#post">url格式设置 &GT;&GT;</a>
</p>
<p>
	<input type="checkbox" name="create_pages[]" value="sort" />
	分类列表 - 每次生成<input type="text" name="sort_limit" value="5" size="2" maxlength="3"/>页
	<a href="?plugin=em_static&do=url#sort">url格式设置 &GT;&GT;</a>
</p>
<p>
	<input type="checkbox" name="create_pages[]" value="tag" />
	标签列表 - 每次生成<input type="text" name="tag_limit" value="5" size="2" maxlength="3"/>页
	<a href="?plugin=em_static&do=url#tag">url格式设置 &GT;&GT;</a>
</p>
<p>
	<input type="checkbox" name="create_pages[]" value="author" />
	作者列表 - 每次生成<input type="text" name="author_limit" value="5" size="2" maxlength="3"/>页
	<a href="?plugin=em_static&do=url#author">url格式设置 &GT;&GT;</a>
</p>
<p>
	<input type="checkbox" name="create_pages[]" value="record" />
	归档列表 - 每次生成<input type="text" name="record_limit" value="5" size="2" maxlength="3"/>页
	<a href="?plugin=em_static&do=url#record">url格式设置 &GT;&GT;</a>
</p>
<p>
	<input type="checkbox" name="create_pages[]" value="single_page" />
	独立页面 - 每次生成<input type="text" name="single_page_limit" value="5" size="2" maxlength="3"/>页
	<a href="?plugin=em_static&do=url#single">url格式设置 &GT;&GT;</a>
</p>
