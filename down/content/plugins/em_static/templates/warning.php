...
if ($options['isurlrewrite'] > 0):
$link_url = Option::EMLOG_VERSION > '5.0' ? 'seo.php' : 'permalink.php';
?>
<div style="border:1px solid #FF6600; text-align: center; color: #ff6600; padding: 2px;">
	请注意: 您博客的日志链接的形式不是默认形式，
	请到<a href="./<?php echo $link_url?>"><u>设置页面</u></a>将博客的url形式设置为<b>默认形式</b>，
	同时请确认<b>启用文章链接别名html后缀</b>没有被选中
</div>
<?php endif;?>
