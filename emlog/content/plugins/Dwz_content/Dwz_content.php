...
function Dwz_content_f($arr){
  ...
  //$namedwz=$return=file_get_contents("https://eps.gs/api/make.php?url=$nameurl");
...
<script type="text/jscript" src="https://apis.eps.gs/js/qrcode.js"></script>
